...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background text-text selection:bg-primary/30 font-sans">
      ...
      <div className="w-full lg:w-[55%] bg-surface flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-16 lg:py-0 relative overflow-hidden">
        ...
        >
          <div className="w-12 h-12 bg-background rounded-2xl flex items-center justify-center mb-10 border border-text/5 shadow-sm">
