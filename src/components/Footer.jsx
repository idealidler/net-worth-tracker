    ...
    <footer className="mt-16 pt-8 pb-12 border-t border-text/5 flex flex-col md:flex-row items-center justify-between gap-6 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <a 
          ...
          className="p-2.5 bg-text/5 rounded-xl text-text-muted hover:text-text hover:bg-text/10 transition-all group"
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="p-2.5 bg-text/5 rounded-xl text-text-muted hover:text-[#0A66C2] hover:bg-[#0A66C2]/10 transition-all group"
        ...
        <a 
          ...
          className="p-2.5 bg-text/5 rounded-xl text-text-muted hover:text-primary hover:bg-primary/10 transition-all group"
