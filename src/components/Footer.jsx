...
const Footer = () => {
  ...
  return (
    <footer className="mt-8 py-4 border-t border-text/5 flex flex-col md:flex-row items-center md:items-center justify-between gap-4 md:gap-6 w-full">
      
      {/* Left Side */}
      <div className="text-center md:text-left flex flex-col items-center md:items-start">
        <p className="text-sm font-medium text-text-muted leading-tight">
          Architected & Engineered by{' '}
          <span className="font-extrabold text-text tracking-wide">
            Akshay Jain
          </span>
        </p>
        ...
        <button 
          ...
          className="mt-1 inline-flex items-center gap-1.5 text-xs font-bold text-text-muted hover:text-primary transition-colors leading-none group"
        >
